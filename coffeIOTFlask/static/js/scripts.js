...
var numPlanta = JSON.parse(script.getAttribute('numPlanta'));
...
function enviarDatos(){
  var mqttDatos = humedadSelecionada.value.toString() + "," + tiempoSelecionado.value.toString()+ "," + numPlanta.toString();
...
{
  var dataMqtt = $.get('/dataMqtt/'+numPlanta);
